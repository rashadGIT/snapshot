      ...
      scanner.render(
        (decodedText) => {
          ...
          if (decodedText.includes('/join/')) {
            scannedToken = decodedText.split('/join/').pop() || decodedText;
          }

          // Auto-navigate to the scanned URL
            ...
            {!scannerActive ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Scan a QR code to join a job instantly
                </p>
                <button
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold">Scanning QR Code...</h3>
                  <button
                    onClick={stopScanner}
